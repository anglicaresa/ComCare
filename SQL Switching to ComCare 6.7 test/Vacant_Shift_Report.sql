...
declare @stringDate varchar(32) = '2017-03-20'
declare @stringDate2 varchar(32) = '2017-03-20'--'2017-01-20'
...
declare @ClassCodeFilter VarChar(8)= 'DSW'
declare @TeamFilt VarChar(128) = 'Individualised Services'
...
order by
	...
	,Case
		...
		When @SortBy = 'ProviderName' then concat (J007.[Last_Name],', ',J007.[Preferred_Name] )
		When @SortBy = 'Team_ClassCode' then J002.[Description]
		end
	,Case
		when @SortBy = 'StartTime' then concat (J007.[Last_Name],', ',J007.[Preferred_Name])
		When @SortBy = 'ProviderName' then 
									convert
									(	varchar(128)
										,IIF
										(
		...
		When @SortBy = 'Team_ClassCode' then J003.[Provider_Class_Code]
		end
--*/
