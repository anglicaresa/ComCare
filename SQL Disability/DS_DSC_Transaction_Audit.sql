...
Description
Short Term Accommodation and Assistance: DASL
----------------------------------------------------------
...
select Activity_Date,Activity_Start_Time ,WI_Record_ID FROM dbo.WI_Activity
where provider_ID = 10012270
and Client_ID IS NOT NULL
order by Schedule_Time
...
SET @StartDate = '20170218 00:00:00.000'
...
-----------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------
Left outer Join [dbo].[Task_Type] J004 on J004.Task_Type_Code = J001.WiA_Schedule_Task_Type--J001.Task_Type_Code
