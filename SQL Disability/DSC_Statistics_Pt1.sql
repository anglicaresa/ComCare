...
select * from [dbo].[Characteristic]
select * from [dbo].[Service_Type]
select * from [dbo].[Service_delivery]
select * from [dbo].[Marital_Status]
select * from [dbo].WI_Activity_Event_Type
select * from [dbo].[Service_Delivery]
select * from [dbo].Actual_Service
select * from [dbo].Task_Type -- connects task_Type_ID and Service_Type_ID

select * from [dbo].Task_Schedule_Allocation -- the golden bullet

select * from [dbo].[Person_Current_Address_Phone]
...
LEFT OUTER JOIN [dbo].[Service_Delivery] J009 ON J009.[Client_ID] = J001.[Client_ID]
