...
declare @NoBuddyShifts int = 0
declare @hideUnAss int = 1
declare @ClassCodeFilter VarChar(8)= 'LA'
--------------------------------------------------------------
--------------------------------------------------------------
--------------------------------------------------------------
--------------------------------------------------------------
...
Left outer join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Service_Provision_Allocation] J004 on J004.[Service_Prov_Position_ID] = J003.[Service_Prov_Position_ID]
inner join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Provider_Classification] J008 on J008.[Provider_Class_Code] = J003.[Provider_Class_Code]
...
(
	...
	From [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Working_Week] WW	
	left outer join [tempdb].[dbo].#temp tmp on 1=1
...
(
	...
	from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Shift] Sh
	left outer join [tempdb].[dbo].#temp tmp on 1=1
	where
		1=1
		and 1 = Case
...
(
	...
	From [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Wi_Activity] WiA
...
Left Outer Join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Person] J007 on J007.[Person_ID] = J006.[Provider_ID]

Left Outer Join
(
	select
		tmp.[date_seq] as 'date_seq'
	From [tempdb].[dbo].#temp tmp
...
Left outer join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].Team_Position J011 on J011.[Service_Prov_Position_ID] = J003.[Service_Prov_Position_ID]
