...
select * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].FC_Funder_Contract_Billing
Funder_Contract_ID
select * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].FB_Contract_Billing
4
--*/
...
SET @EndDate = '20161218 00:00:00.000'
PRINT @StartDate
PRINT @EndDate
...
(
	select
		...
		,CCB.Contract_Billing_ID as 'Contract_Billing_ID'
		,ROW_NUMBER ()
			over 
			(
...
INNER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FC_Contract_Area_Product] J010 ON J010.[CAP_ID] = J001.[CAP_ID]
