...
LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Personal_Contact] J003 ON J003.[Person_ID] = J001.[Client_ID]
...
LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Service_Type] J006 ON J006.[Service_Type_Code] = J002.[Service_Type_Code]
LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Service_Delivery_Outcome] J007 ON J007.[Serv_Del_Outcome_Code] = J002.[Serv_Del_Outcome_Code]

INNER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].Person J008 ON J008.[Person_ID] = J003.[Contact_ID]
