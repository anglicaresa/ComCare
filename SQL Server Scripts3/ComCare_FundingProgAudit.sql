...
/*
select * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Funding_Program]
select * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Service_Delivery]
select * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FC_Funder_Contract] 
select * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FC_Client_Contract]
...
LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Funding_Program] J003 ON J003.[Funding_Prog_Code] = J002.[Funding_Prog_Code]

LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FC_Client_Contract] J004 ON J004.[Client_ID] = J001.[Client_ID]
LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FC_Funder_Contract] J005 ON J005.[Funder_Contract_ID] = J004.[Funder_Contract_ID] 

LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FB_Client_Contract_Billing] J006 ON J006.[Client_ID] = J001.[Client_ID]
LEFT OUTER JOIN [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[FC_Funder_Contract] J007 ON J007.[Funder_Contract_ID] = J006.[Funder_Contract_ID]-- and J007.[Funder_Contract_ID] = J004.[Funder_Contract_ID] 
