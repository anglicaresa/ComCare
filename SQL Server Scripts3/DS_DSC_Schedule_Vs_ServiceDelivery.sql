...
DECLARE @StartDate AS DATETIME = '20170125 00:00:00.000'
...
--	,J001.RN
	...
	,IIF(J009.Organisation_Name = 'NDIA National Disability Insurance Agency', 'NDIS funded','Self Managed') 'Funding_Type'
	,J011.Description 'contract_type'
...
Left outer Join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].[Task_Type] J004 on J004.Task_Type_Code = J001.WiA_Schedule_Task_Type
...
Inner Join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].Person J012 ON J012.Person_ID = J001.Provider_ID
Inner Join [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].Person J013 ON J013.Person_ID = J001.Client_ID
--select top 1 * from [APPSQL-3\COMCAREPROD].[comcareprod].[dbo].Person
Where 
	1=1
