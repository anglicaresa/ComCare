...
declare @Start_Date date = cast('2017-06-26' as date)
declare @End_Date date = cast('2017-06-30' as date)
--DECLARE @OrgName AS Varchar(64) = 'Home Care north'
DECLARE @OrgName AS Varchar(64) = 'All Hallows Court'
...
Insert into @IndirectLookupPayType values
	...
	,(57,1,0)	--57 Start Shift no break
...
begin
	...
	begin
		insert into @Joined_Task Values ( @i_PID,@t_ActivityDate,@J_IndTask_Type)
