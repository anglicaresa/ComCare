...
declare @Client_ID int = 10016245

--declare @FiltIncomeTested int = 1
declare @ClaimYear int = 2017
declare @ClaimPeriod_Start int = 8
...
--	where CC.Effective_To_Date is null or CC.Effective_To_Date > @EndDate or CC.Effective_To_Date between @StartDate and @EndDate
)J001
...
--	and (J001.Effective_To_Date is null or J001.Effective_To_Date > @EndDate or J001.Effective_To_Date between @StartDate and @EndDate)
