...
Select * from dbo.FC_Client_Contract where client_ID = 10069222
...
--/*
Declare @ServiceCollection_Table Table (Client_ID int, Service_ Varchar(256))
...
Declare @ServiceCollection_Table_Joined Table (Client_ID int, Services_ Varchar(MAX))
